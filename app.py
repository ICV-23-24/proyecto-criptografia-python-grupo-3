...
#     # Obtén la opción de descifrado del formulario
#     decrypt_option = request.form.get('decrypt_option')

#     if decrypt_option == 'local':
...
#             return f"Error al descifrar el archivo local: {str(e)}"
#     elif decrypt_option == 'destino':
#         # Descifrar en la carpeta de destino
#         carpeta_destino = '\\\\DESKTOP-2HO19U6\\Colombia is Back'
#         if not os.path.exists(carpeta_destino):
#             os.makedirs(carpeta_destino)
...
#         # Utilizar el nombre del archivo cifrado para construir la ruta de destino
#         nombre_archivo_cifrado = secure_filename(file.filename)
#         ruta_destino = os.path.join(carpeta_destino, nombre_archivo_cifrado.replace('_cifrado.txt', '_descifrado.txt'))
...
#         except Exception as e:
#             return f"Error al descifrar el archivo en la carpeta de destino: {str(e)}"

#     return "Opción de descifrado no válida"
